...
This knowledge is governed as durable, evidence-bearing artifacts: it records and informs, but never grants approval or overrides the authority chain. Status records stay lean: update roadmap, current-status, and dev-log entries when they change phase authority, current decisions, open tails, user-visible truth, or a safety boundary, not for bookkeeping already proven by git history, CI, PR metadata, `docs/INDEX.md`, or the drift report.
