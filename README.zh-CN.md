...
3. 选择起点：小型项目用 [`templates/minimal-ai-flow.md`](templates/minimal-ai-flow.md)，需要正式评审的项目用 [`templates/governed-ai-flow.md`](templates/governed-ai-flow.md)。
