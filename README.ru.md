...
- **Строгое управление безопасностью и бережное управление статусом** — границы безопасности проверяются строго, а статусные доказательства остаются краткими: roadmap, текущий статус и журналы разработки фиксируют фазовую власть, текущие решения, открытые хвосты и границы безопасности, а не дублируют то, что уже подтверждают история git, CI, метаданные PR или сгенерированные артефакты. См. [`docs/verification-standards.md`](docs/verification-standards.md).
