...
- **Gouvernance de sécurité stricte, gouvernance de statut légère** — les limites de sécurité restent fortement vérifiées, tandis que les preuves de statut restent concises : feuille de route, statut courant et journaux de développement consignent l'autorité de phase, les décisions en cours, les queues ouvertes et les limites de sécurité, sans recopier ce que l'historique git, la CI, les métadonnées de PR ou les artefacts générés prouvent déjà. Voir [`docs/verification-standards.md`](docs/verification-standards.md).
