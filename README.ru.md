...
- **Навыки** — переиспользуемые операционные процедуры в [`skills/`](skills/): зонтичный навык [`lithos`](skills/lithos/SKILL.md) направляет агента на принятие, аудит, обновление, рецензирование или контроль выпуска проекта, наряду с целевыми навыками для создания, аудита и адаптации локального потока ИИ.
...
│   ├── lithos/                Зонтичный навык: маршрутизирует принятие / аудит / обновление / рецензию / выпуск
